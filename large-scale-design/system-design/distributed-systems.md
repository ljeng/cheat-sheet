...
```mermaid
graph TB
    subgraph "Customer-facing API Tier<br/>99.99% availability"
...
1. Since the business wants 99.9 percent availability from the system, let's set a goal for the customer-facing API tier[^03] at 99.99 percent availability.
